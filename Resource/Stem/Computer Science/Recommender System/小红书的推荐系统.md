...
2. 粗排：用机器学习模型预估用户对笔记的兴趣，保留分数最高的几百篇笔记，例用规模比较小的机器学习模型给几千篇笔记打分，按照分数做排序和截断，保留分数最高的几百篇笔记
...
```json
{
	...
	"elements": [
		...
		},
		{
			"id": "d7IqoZIQ",
			"type": "text",
			"x": -114.25798390972481,
			"y": 2098.2678401732214,
			"width": 8,
			"height": 25,
			"angle": 0,
			"strokeColor": "#1e1e1e",
			...
			"seed": 1598205110,
			"version": 3,
			"versionNonce": 460529782,
			"isDeleted": true,
			"boundElements": null,
			"updated": 1778815057424,
			"locked": false,
			"text": "",
			"rawText": "",
			"fontSize": 20,
	...
	"appState": {
		...
		"scrollX": 228.87731066332987,
		"scrollY": -1679.2373302030908,
		"zoom": {
			"value": 0.890209
		},
